        ...
        <Suspense fallback={<div>Loading...</div>}>
            <Layout className={styles.layout}>
                <Content
                    ...
                    style={{
                        gap: isMobileView ? "0" : "5rem",
                        padding: isMobileView ? "12px 12px" : "48px 12px",
                ...
                >
                    ...
                    <Row style={{ height: "100%", width: "100%" }}>
                        {(!isMobileView ||
                            (isMobileView && selectedBlog == null)) && (
                            <Col
                                span={isMobileView ? 24 : 4}
                                style={{
                                    padding: "0rem 1rem",
                                    overflowY: "auto",
                                    display: displayMenu,
