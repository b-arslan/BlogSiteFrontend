...
const LeafletMap = () => {
    ...
    useEffect(() => {
        const coordinates: L.LatLngExpression = [
            37.86994421452708, 32.474147158457434,
        ]; // Coordinates for Konya I&G Danışmanlık
        ...
        if (!mapInstanceRef.current && mapContainerRef.current) {
            ...
            const customIcon = L.icon({
                iconUrl:
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Map_marker.svg/1200px-Map_marker.svg.png", // Apple Maps-like pin,
            ...
            popupContent.innerHTML = "İ&G Danışmanlık";
